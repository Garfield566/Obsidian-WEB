...
> | | |
> |---|---|
> | **Created-by** | <ul style="margin: 0; padding-left: 15px;"><li>Q-Hayashida</li></ul> |
> | **Produced-by** | <ul style="margin: 0; padding-left: 15px;"><li>MAPPA</li></ul> |
> | **Country** | <ul style="margin: 0; padding-left: 15px;"><li>Japan 🇯🇵</li></ul> |
> | **Platform** | <ul style="margin: 0; padding-left: 15px;"><li>Netflix</li></ul> |
> | **Directors** | <ul style="margin: 0; padding-left: 15px;"><li>Yuichiro-Hayashi</li></ul> |
> | **Writers** | <ul style="margin: 0; padding-left: 15px;"><li>Hiroshi-Seko</li></ul> |
> | **Composers** | <ul style="margin: 0; padding-left: 15px;"><li>(K)NoW_NAME</li></ul> |
> | **Animation** | <ul style="margin: 0; padding-left: 15px;"><li>3D-CGI</li><li>Hand-drawn-elements</li><li>Gritty-visual-style</li></ul> |
> ###### Series-Details
> | | |
> |---|---|
> | **Genre** | <ul style="margin: 0; padding-left: 15px;"><li>Dark-fantasy</li><li>Action</li><li>Horror-comedy</li><li>Science-fantasy</li></ul> |
> | **Themes** | <ul style="margin: 0; padding-left: 15px;"><li>Identity</li><li>Violence</li><li>Magic-vs-science</li><li>Underground-societies</li></ul> |
> | **Seasons** | <ul style="margin: 0; padding-left: 15px;"><li>1 (2020)</li></ul> |
> | **Episodes** | <ul style="margin: 0; padding-left: 15px;"><li>12</li></ul> |
> | **Runtime** | <ul style="margin: 0; padding-left: 15px;"><li>23-25-minutes-per-episode</li></ul> |
> ###### Tags
> | | |
> |---|---|
...
Dans un univers chaotique où la magie est omniprésente et où règne la loi du plus fort, **Caiman**, un homme à tête de lézard amnésique, cherche désespérément à retrouver son identité. Vivant dans "The Hole", une cité sordide où les utilisateurs de magie expérimentent librement sur les habitants, Caiman traque les magiciens pour résoudre le mystère de son état actuel.

Aux côtés de **Nikaido**, une cuisinière talentueuse et sa fidèle alliée, il interroge ses ennemis après les avoir mordus, espérant que leur réponse dévoilera le secret caché au fond de sa gorge, où réside une entité mystérieuse. Pendant ce temps, **En**, un sorcier influent, envoie ses sbires, dont les redoutables **Shin** et **Noi**, pour éliminer Caiman et comprendre ses pouvoirs uniques.

La série oscille entre scènes brutales, moments absurdes et une exploration surprenante de l'humanité dans un monde déshumanisé. Avec ses personnages excentriques, ses intrigues tordues et un univers à la fois sombre et bizarre, _Dorohedoro_ offre une expérience unique, mêlant violence, humour noir et une touche de surnaturel.
## Soundtrack 

**Tracklist principal** :

1. _“Welcome_to_Chaos”_ – **(K)NoW_NAME**
2. _“Night_SURF”_ – **(K)NoW_NAME**
3. _“Who_Am_I”_ – **(K)NoW_NAME**
4. _“The_Hole's_Melody”_ – **(K)NoW_NAME**
5. _“Reptilian_Revenge”_ – **(K)NoW_NAME**
6. _“Nikaido's_Day”_ – **(K)NoW_NAME**
7. _“Sorcerer's_Showdown”_ – **(K)NoW_NAME**
8. _“Magic_vs_Curse”_ – **(K)NoW_NAME**
9. _“Endless_Battle”_ – **(K)NoW_NAME**
10. _“Final_Puzzle”_ – **(K)NoW_NAME**
