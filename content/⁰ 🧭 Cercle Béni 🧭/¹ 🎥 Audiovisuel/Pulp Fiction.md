...
> | | |
> |---|---|
> | **Created-by** | <ul style="margin: 0; padding-left: 15px;"><li>Quentin-Tarantino</li><br><li>Roger-Avery</li></ul> |
> | **Produced-by** | <ul style="margin: 0; padding-left: 15px;"><li>Miramax</li><br><li>A-Band-Apart</li></ul> |
...
> | **Directors** | <ul style="margin: 0; padding-left: 15px;"><li>Quentin-Tarantino</li></ul> |
> | **Writers** | <ul style="margin: 0; padding-left: 15px;"><li>Quentin-Tarantino</li><br><li>Roger-Avery</li></ul> |
> | **Composers** | <ul style="margin: 0; padding-left: 15px;"><li>Various-Artists</li></ul> |
> ###### Movie-Details
> | | |
> |---|---|
> | **Genre** | <ul style="margin: 0; padding-left: 15px;"><li>Crime</li><br><li>Black-comedy</li><br><li>Neo-noir</li></ul> |
> | **Themes** | <ul style="margin: 0; padding-left: 15px;"><li>Redemption</li><br><li>Violence</li><br><li>Chance</li></ul> |
> | **Runtime** | <ul style="margin: 0; padding-left: 15px;"><li>154-minutes</li></ul> |
> ###### Tags
> | | |
> |---|---|
...
_Pulp Fiction_ tisse une série d’histoires interconnectées dans le monde du crime à Los Angeles, explorant des personnages excentriques et des situations inattendues. Le film suit Vincent Vega et Jules Winnfield, deux tueurs à gages, la femme du patron mafieux Mia Wallace, et un boxeur nommé Butch Coolidge, à travers une narration non linéaire. Avec son style audacieux, ses dialogues percutants et son mélange de violence et d’humour noir, _Pulp Fiction_ a redéfini le cinéma indépendant des années 90.


## Soundtrack 
### **Tracklist de _Pulp Fiction_** :

1. **Misirlou** : Dick-Dale-&-His-Del-Tones
2. **Jungle_Boogie** : Kool-&-The-Gang
3. **Let's_Stay_Together** : Al-Green
4. **Son_of_a_Preacher_Man** : Dusty-Springfield
5. **You_Never_Can_Tell** : Chuck-Berry
6. **Girl,_You'll_Be_a_Woman_Soon** : Urge-Overkill
7. **If_Love_Is_a_Red_Dress_(Hang_Me_in_Rags)** : Maria-McKee
8. **Flowers_on_the_Wall** : The-Statler-Brothers
9. **Surf_Rider** : The-Lively-Ones
10. **Bullwinkle_Part_II** : The-Centurians
