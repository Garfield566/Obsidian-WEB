...
> | | |
> |---|---|
> | **Created-by** | <ul style="margin: 0; padding-left: 15px;"><li>Naoki-Urasawa</li><br><li>Osamu-Tezuka</li></ul> |
> | **Produced-by** | <ul style="margin: 0; padding-left: 15px;"><li>Genco</li><br><li>Studio-M2</li></ul> |
> | **Country** | <ul style="margin: 0; padding-left: 15px;"><li>Japan 🇯🇵</li></ul> |
> | **Platform** | <ul style="margin: 0; padding-left: 15px;"><li>Netflix</li></ul> |
> | **Directors** | <ul style="margin: 0; padding-left: 15px;"><li>Toshio-Kawaguchi</li></ul> |
> | **Writers** | <ul style="margin: 0; padding-left: 15px;"><li>Naoki-Urasawa</li><br><li>Takashi-Nagasaki</li></ul> |
> | **Composers** | <ul style="margin: 0; padding-left: 15px;"><li>Yugo-Kanno</li></ul> |
> | **Animation** | <ul style="margin: 0; padding-left: 15px;"><li>3D-CGI</li><br><li>Cel-shaded</li><br><li>Urasawa-style-adaptation</li></ul> |
> ###### Series-Details
> | | |
> |---|---|
> | **Genre** | <ul style="margin: 0; padding-left: 15px;"><li>Sci-fi</li><br><li>Mystery</li><br><li>Psychological-thriller</li></ul> |
> | **Themes** | <ul style="margin: 0; padding-left: 15px;"><li>Artificial-intelligence</li><br><li>Humanity</li><br><li>War-trauma</li></ul> |
> | **Episodes** | <ul style="margin: 0; padding-left: 15px;"><li>8</li></ul> |
> | **Runtime** | <ul style="margin: 0; padding-left: 15px;"><li>55-70-minutes-per-episode</li></ul> |
> ###### Tags
> | | |
> |---|---|
...
_Pluto_ se déroule dans un futur où humains et robots coexistent. L’histoire suit **Gesicht**, un détective-robot chargé d’enquêter sur une série de meurtres brutaux visant à la fois des humains influents et les robots les plus puissants du monde. Tandis que l'enquête progresse, Gesicht découvre une conspiration complexe qui remet en question les fondements mêmes de l’humanité et de la conscience robotique.

Inspirée par l’arc "Le robot le plus fort du monde" du célèbre manga _Astro Boy_ d'Osamu Tezuka, cette série revisite l'œuvre avec une touche plus mature et sombre, mettant en lumière des thèmes comme la discrimination, la guerre, et le sens de la vie. Avec des personnages profondément humains, qu’ils soient robots ou non, _Pluto_ offre une réflexion poignante sur la condition humaine et les dilemmes éthiques de l'intelligence artificielle.

## *Soundtrack*

#### **Tracklist** 

1. _“Pluto_Main_Theme”_ – **Yūgo-Kanno**
2. _“Memories_of_War”_ – **Yūgo-Kanno**
3. _“The_Last_Robot”_ – **Yūgo-Kanno**
4. _“Melancholy_of_Gesicht”_ – **Yūgo-Kanno**
5. _“Artificial_Soul”_ – **Yūgo-Kanno**
6. _“Human_and_Machine”_ – **Yūgo-Kanno**
7. _“Unraveling_the_Truth”_ – **Yūgo-Kanno**
8. _“Tragedy_in_Uran”_ – **Yūgo-Kanno**
9. _“Heart_of_Pluto”_ – **Yūgo-Kanno**
10. _“Final_Confrontation”_ – **Yūgo-Kanno**
11. _“Hope_in_the_Future”_ – **Yūgo-Kanno**
