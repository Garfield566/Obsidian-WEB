...
> | | |
> |---|---|
> | **Created-by** | <ul style="margin: 0; padding-left: 15px;"><li>Katsuhito-Ishii</li><br><li>Yōji-Enokido</li></ul> |
> | **Produced-by** | <ul style="margin: 0; padding-left: 15px;"><li>Madhouse</li></ul> |
...
> | **Directors** | <ul style="margin: 0; padding-left: 15px;"><li>Takeshi-Koike</li></ul> |
> | **Writers** | <ul style="margin: 0; padding-left: 15px;"><li>Katsuhito-Ishii</li><br><li>Yōji-Enokido</li></ul> |
> | **Composers** | <ul style="margin: 0; padding-left: 15px;"><li>James-Shimoji</li></ul> |
> | **Animation** | <ul style="margin: 0; padding-left: 15px;"><li>Hand-drawn</li><br><li>7-year-production</li><br><li>Hyper-kinetic-style</li></ul> |
> ###### Movie-Details
> | | |
> |---|---|
> | **Genre** | <ul style="margin: 0; padding-left: 15px;"><li>Sci-fi</li><br><li>Racing</li><br><li>Action</li></ul> |
> | **Themes** | <ul style="margin: 0; padding-left: 15px;"><li>Underground-racing</li><br><li>Rebellion</li><br><li>Extreme-competition</li></ul> |
> | **Runtime** | <ul style="margin: 0; padding-left: 15px;"><li>102-minutes</li></ul> |
> ###### Tags
> | | |
> |---|---|
...
8. *"Roboworld"* `2:07`  
9. *"Europass"* `3:18`  
10. *"Mogura_Oyaji"* `2:21`  
11. *"Oasis"* `2:08`  
12. *"And_It's_So_Beautiful"* (feat. Kitty_Brown) `4:50`  
13. *"Shinkai"* `2:24`  
14. *"MachineHead"* `1:03`  
15. *"Capture_Operation"* `2:18`  
16. *"Let_Me_Love_You"* (feat. Veronica_Torraca-Bragdon) `2:26`  
17. *"Get_The_Stones"* (feat. Andrew_O.Jones) `3:23`  
18. *"Crab_Sonoshee"* `1:37`  
19. *"Kare_No_Shift_Wa_Bunbunbun"* (feat. SUPER_BOINS) `3:48`  
20. *"LynchMan_&_JohnnyBoya"* `1:16`  
21. *"Redline_News"* `0:23`  
22. *"Gori-Rider"* `0:56`  
23. *"Miki_&_Todoroki"* `0:23`  
24. *"Put-up_Guy"* `0:41`  
25. *"Red_Angels"* `0:48`  
26. *"Three-point_Decomposition_Cannon"* `0:54`  
27. *"Tension"* `1:37`  
28. *"Chatter_Void"* `1:05`  
29. *"Volton_Unit"* `2:07`  
30. *"Vertical_Drop"* `1:41`  
31. *"Moniter_Room"* `1:06`  
32. *"Sand_Biker"* `1:28`  
33. *"Spinning_Car"* `1:53`  
34. *"Trouble"* `1:33`  
35. *"Semimaru"* `1:26`  
36. *"Gangster"* `0:53`  
37. *"Flying_Finger"* `0:23`  
38. *"Funky_Boy"* `1:42`  
39. *"Redline"* `3:31`  
40. *"Exceed_Limit"* `1:32`  
41. *"Dead_Heat"* `1:03`  
42. *"Redline_Day"* (feat. Rob_Laufer) `4:53`  
