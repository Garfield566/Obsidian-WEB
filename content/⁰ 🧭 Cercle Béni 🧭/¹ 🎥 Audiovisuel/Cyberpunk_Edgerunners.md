...
> | | |
> |---|---|
> | **Created-by** | <ul style="margin: 0; padding-left: 15px;"><li>Rafal-Jaki<br>CD-Projekt-Red</li></ul> |
> | **Produced-by** | <ul style="margin: 0; padding-left: 15px;"><li>CD-Projekt-Red<br>Trigger</li></ul> |
> | **Country** | <ul style="margin: 0; padding-left: 15px;"><li>Japan 🇯🇵<br>Poland 🇵🇱</li></ul> |
> | **Platform** | <ul style="margin: 0; padding-left: 15px;"><li>Netflix</li></ul> |
> | **Directors** | <ul style="margin: 0; padding-left: 15px;"><li>Hiroyuki-Imaishi</li></ul> |
> | **Writers** | <ul style="margin: 0; padding-left: 15px;"><li>Masahiko-Otsuka</li><li>Yoshiki-Usa</li></ul> |
> | **Composers** | <ul style="margin: 0; padding-left: 15px;"><li>Akira-Yamaoka</li></ul> |
> | **Animation** | <ul style="margin: 0; padding-left: 15px;"><li>Studio-Trigger</li><li>2D-Animation</li><li>Cyberpunk-visuals</li></ul> |
> ###### Series-Details
> | | |
> |---|---|
> | **Genre** | <ul style="margin: 0; padding-left: 15px;"><li>Cyberpunk</li><li>Action</li><li>Drama</li><li>Sci-Fi</li></ul> |
> | **Seasons** | <ul style="margin: 0; padding-left: 15px;"><li>1 (2022)</li></ul> |
> | **Episodes** | <ul style="margin: 0; padding-left: 15px;"><li>10</li></ul> |
> | **Runtime** | <ul style="margin: 0; padding-left: 15px;"><li>24-26-minutes-per-episode</li></ul> |
> ###### Setting-Characters
> | | |
> |---|---|
...
Dans la dystopie hyper-technologique de **Night City**, où la ligne entre l’homme et la machine est floue, **David Martinez**, un jeune étudiant talentueux, voit sa vie basculer après une tragédie familiale. Contraint de quitter ses études et de lutter pour sa survie dans les bas-fonds de la ville, il se retrouve en possession d’un implant cybernétique militaire surpuissant.

Désespéré et rempli de rage, David s’immerge dans le monde dangereux des **edgerunners**, des mercenaires cybernétiques vivant en marge de la loi. Guidé par **Lucy**, une mystérieuse netrunner, et une équipe de criminels chevronnés, David découvre les horreurs et les merveilles du transhumanisme. Chaque mission le rapproche de son rêve de devenir une légende dans le chaos qu’est Night City, mais l’utilisation excessive des implants met en péril son humanité et sa santé mentale.

La série explore les thèmes de la perte, de l’ambition, et du prix à payer pour survivre dans un monde où la technologie est à la fois une bénédiction et une malédiction. Avec une narration poignante, des personnages complexes, et une esthétique visuelle saisissante, _Cyberpunk: Edgerunners_ est une plongée intense dans l’univers sombre et captivant du jeu vidéo **Cyberpunk 2077**.
## Soundtrack 

**Tracklist principaux thèmes et chansons emblématiques**

- _“This_Fire”_ – **Franz-Ferdinand**
- _“I_Really_Want_to_Stay_at_Your_House”_ – **Rosa-Walton**, **Hallie-Coggins**
- _“Major_Lazer”_ – **Run-The-Jewels**
- _“Pain”_ – **LeDestroy**
- _“Let_You_Down”_ – **Dawg**
- _“Who’s_Ready_for_Tomorrow”_ – **Rat_Boy**
- _“Cyber_Psycho”_ – **PTSD**
- _“Edge_of_My_Life”_ – **Tina_Guo**
- _“Never_Fade_Away”_ – **Pondsmith-Collaborators**
