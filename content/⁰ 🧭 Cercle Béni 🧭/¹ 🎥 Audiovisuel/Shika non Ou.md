---
dtbe-pluin: bic
cover: http:m.medi-mzon.comimeMMV5BYjc4MzVlOAtNjEzYi00MmE5LWIzYzYtMM5YzE1OViN2ExXkEyXkFqcc@._V1_.jp
---
# 🎥 **Monster**
> [!infobox]
> # Monster
...
> | | |
> |---|---|
> | **Created-by** | <ul style="margin: 0; padding-left: 15px;"><li>Naoki-Urasawa</li></ul> |
> | **Produced-by** | <ul style="margin: 0; padding-left: 15px;"><li>Madhouse</li><li>Nippon-TV</li></ul> |
> | **Country** | <ul style="margin: 0; padding-left: 15px;"><li>Japan 🇯🇵</li></ul> |
> | **Platform** | <ul style="margin: 0; padding-left: 15px;"><li>Nippon-TV</li></ul> |
> | **Directors** | <ul style="margin: 0; padding-left: 15px;"><li>Masayuki-Kojima</li></ul> |
> | **Writers** | <ul style="margin: 0; padding-left: 15px;"><li>Naoki-Urasawa</li><li>Tatsuhiko-Urahata</li></ul> |
> | **Composers** | <ul style="margin: 0; padding-left: 15px;"><li>Kuniaki-Haishima</li></ul> |
> | **Animation** | <ul style="margin: 0; padding-left: 15px;"><li>Traditional-2D</li><li>Realistic-style</li><li>European-setting</li></ul> |
> ###### Series-Details
> | | |
> |---|---|
> | **Genre** | <ul style="margin: 0; padding-left: 15px;"><li>Psychological-thriller</li><li>Medical-drama</li><li>Crime</li></ul> |
> | **Themes** | <ul style="margin: 0; padding-left: 15px;"><li>Morality</li><li>Nature-of-evil</li><li>Redemption</li><li>Medical-ethics</li></ul> |
> | **Seasons** | <ul style="margin: 0; padding-left: 15px;"><li>1 (2004–2005)</li></ul> |
> | **Episodes** | <ul style="margin: 0; padding-left: 15px;"><li>74</li></ul> |
> | **Runtime** | <ul style="margin: 0; padding-left: 15px;"><li>24-minutes-per-episode</li></ul> |
> ###### Tags
> | | |
> |---|---|
> | **People** | <ul style="margin: 0; padding-left: 15px;"><li>#Naoki-Urasawa</li><li>#Masayuki-Kojima</li><li>#Kuniaki-Haishima</li></ul> |
> | **Studios** | <ul style="margin: 0; padding-left: 15px;"><li>#Madhouse</li></ul> |
> | **Concepts** | <ul style="margin: 0; padding-left: 15px;"><li>#Psychological-Thriller</li><li>#Medical-Drama</li><li>#Crime-Mystery</li></ul> |
...
## 🎵 Soundtrack 
### Saison-1 
1. *"For_the_love_of_life_(Ending_theme_full_version)"* 
2. *"Grain_(Opening_theme)"* 
3. *"Drift_mind"* 
4. *"Part"* 
5. *"Float_power"* 
6. *"Collage_man"* 
