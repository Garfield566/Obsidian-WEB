...
note-scénario: "✨✨✨✨"
note-visuel: "✨✨✨✨"
cover: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRko3azLvdItH8mGwlHIfl8I9fLUSHXUIFxUw&s"
...
tags:
  ...
  - "School_Life_Theme"
  - "Memories_of_Youth"
Acteurs principaux: "(doublage japonais) : Takagi Wataru (Eikichi Onizuka), Ayako Kawasumi (Azusa Fuyutsuki)"
---
...
> | | |
> |---|---|
> | **Created-by** | <ul style="margin: 0; padding-left: 15px;"><li>Tohru-Fujisawa</li></ul> |
> | **Produced-by** | <ul style="margin: 0; padding-left: 15px;"><li>Fuji-TV<br>Pierrot</li></ul> |
> | **Country** | <ul style="margin: 0; padding-left: 15px;"><li>Japan 🇯🇵</li></ul> |
> | **Platform** | <ul style="margin: 0; padding-left: 15px;"><li>Fuji-TV</li></ul> |
> | **Directors** | <ul style="margin: 0; padding-left: 15px;"><li>Masayuki-Fujihara</li></ul> |
> | **Writers** | <ul style="margin: 0; padding-left: 15px;"><li>Tohru-Fujisawa</li><li>Masashi-Sogo</li></ul> |
> | **Composers** | <ul style="margin: 0; padding-left: 15px;"><li>Yusuke-Honma</li></ul> |
> | **Animation** | <ul style="margin: 0; padding-left: 15px;"><li>Traditional-2D</li><li>90s-anime-style</li></ul> |
> ###### Series-Details
> | | |
> |---|---|
> | **Genre** | <ul style="margin: 0; padding-left: 15px;"><li>Comedy-drama</li><li>Slice-of-life</li><li>School</li></ul> |
> | **Themes** | <ul style="margin: 0; padding-left: 15px;"><li>Youth-rebellion</li><li>Alternative-education</li><li>Redemption</li></ul> |
> | **Seasons** | <ul style="margin: 0; padding-left: 15px;"><li>1 (1999–2000)</li></ul> |
> | **Episodes** | <ul style="margin: 0; padding-left: 15px;"><li>43</li></ul> |
> | **Runtime** | <ul style="margin: 0; padding-left: 15px;"><li>23-minutes-per-episode</li></ul> |
> ###### Tags
> | | |
> |---|---|
...
Eikichi Onizuka, ancien délinquant et motard, décide de devenir le plus grand enseignant de tous les temps, non pas par vocation, mais pour des raisons égoïstes et hilarantes. Pourtant, son approche non conventionnelle, sa perspicacité, et son grand cœur finissent par avoir un impact profond sur les vies de ses élèves rebelles et de ses collègues. _Great Teacher Onizuka_ aborde des thèmes tels que la rédemption, la critique du système éducatif, et les liens humains avec humour et émotion.


## Soundtrack 

- _Driver's High_ – L'Arc~~en~~Ciel (Opening 1)
- _Hitori no Yoru_ – Porno Graffitti (Opening 2)
- _Last Piece_ – Kirari (Ending 1)
- _Shizuku_ – Miwako Okuda (Ending 2)
- _School Life Theme_ – Yusuke Honma
- _Memories of Youth_ – Yusuke Honma
