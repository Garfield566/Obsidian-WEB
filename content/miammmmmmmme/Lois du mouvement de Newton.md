---
nom: "Lois du mouvement de Newton"
qid: Q38433
type: loi_physique
categorie: loi_physique
tags: "#physique/loi"
image: https://commons.wikimedia.org/wiki/Special:FilePath/Newtons_laws_in_latin.jpg
---
...
> [!Infobox]
> **Lois du mouvement de Newton**
> ![[https://commons.wikimedia.org/wiki/Special:FilePath/Newtons_laws_in_latin.jpg|300]]
> - **Nomme d'apres** : Isaac Newton
> - **Compose de** : première loi de Newton, principe fondamental de la dynamique, troisième loi de Newton
> - **Découvert(e) ou inventé(e) par** : Isaac Newton
> - **Publication** : 5 juillet 1687
> - **Lieu de publication** : Londres
> - **Discipline dont c'est l'objet** : mécanique classique

Les lois du mouvement de Newton sont un ensemble de principes à la base de la grande théorie de Newton sur le mouvement des corps, appelée mécanique newtonienne ou mécanique classique. À ces lois générales du mouvement, Newton a ajouté la loi de la gravitation universelle permettant d'expliquer aussi bien la chute des corps que le mouvement de la Lune autour de la Terre.
...
Dans un référentiel galiléen, la dérivée de la quantité de mouvement 
 ...
 d'un solide est égale à la somme des forces extérieures 

 ${\vec {\mathrm {F} }}_{i}$

 qui s'exercent sur le solide:

Cette expression de la deuxième loi de Newton n'étant valable que pour un système de masse constante, elle peut être reformulée de façon équivalente de la manière suivante:
...
Soit un corps de masse 
 ...
 de son centre d'inertie dans un référentiel galiléen est proportionnelle à la résultante des forces qu'il subit. Le coefficient de proportionnalité est 

 $1/m$

Ceci est souvent récapitulé dans l'équation:

 $$\vec {a}=\frac {1}{m}\sum _{i}{{\vec {\mathrm {F} }}_{i}}$$

ou, de façon équivalente:

 $$\sum _{i}{{\vec {\mathrm {F} }}_{i}}=m\vec {a}$$
...
En combinant cette loi et le principe fondamental de la dynamique, on démontre la prédiction de Galilée selon laquelle, dans le vide, tous les objets tombent à la même vitesse (en admettant implicitement que masse inertielle et masse gravitationnelle sont égales).

## « Quatrième corollaire » de Newton : principe de relativité

Newton a mis en évidence dans ses Principia la notion de relativité du mouvement dans les définitions précédant le livre premier. Il introduit dans les scholies II et IV la notion d'espace absolu et indique dans le corollaire V des lois que:
...
Il convient de nuancer: si Newton avait connaissance des travaux de Galilée, son rôle a été de formaliser les idées de Galilée et d'en tirer les conclusions qui ont permis de construire la mécanique. Quand Newton affirme « Si j'ai vu plus loin que les autres, c'est parce que j'ai été porté par des épaules de géants. », le lecteur averti est censé comprendre que le travail s'inscrit dans la continuité de celui de Galilée. En fait, on pourrait même dire que Newton n'a pas précisé que le principe d'inertie et le principe de relativité, sur lesquels il s'est fondé pour construire toute la mécanique, ont été édictés par Galilée, tout simplement parce qu'il estime que le lecteur est censé le savoir!
...
Newton sortait donc hardiment du cadre imposé par la physique de l'époque, d'où une critique véhémente, l'action instantanée à distance étant récusée (elle gênait d'ailleurs Newton lui-même), comme insensée (Rømer venait de montrer la finitude de la célérité de la lumière). En 1906, Poincaré proposera une hypothèse moins choquante: la gravitation se propage à la vitesse limite c.
...
« J'ai marqué plus d'une fois, que je tenais l'Espace pour quelque chose de purement relatif, comme le Temps; pour un ordre des Coexistences, comme le Temps est un ordre de Successions… »
...
La mécanique newtonienne étudie surtout les systèmes macro-physiques. Dans ce contexte, l'espace et l'énergie sont implicitement considérés comme étant continus. Or, le monde de la mécanique quantique est celui des systèmes micro-physiques, pour lesquels ces concepts sont quantifiés.
...
, on connaît 
 ...
 $$\vec {r}(t)=\int _{0}^{t}\vec {v}(t)\mathrm {d} t+\vec {r}(0)$$
