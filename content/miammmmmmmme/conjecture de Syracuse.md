...
image: https://commons.wikimedia.org/wiki/Special:FilePath/Collatz-graph-all-30-no27-loop.svg
---
...
> [!Infobox]
> **Conjecture de Syracuse**
> ![[https://commons.wikimedia.org/wiki/Special:FilePath/Collatz-graph-all-30-no27-loop.svg|300]]
> - **Nomme d'apres** : Lothar Collatz, grêle, Université de Syracuse, Shizuo Kakutani, Stanisław Ulam
> - **Découvert(e) ou inventé(e) par** : Lothar Collatz
> - **Publication** : 1937
> - **Partie de** : problèmes non résolus en mathématiques
> - **Sujet ou thème principal** : suite de Syracuse
> - **Aspect de** : dynamique arithmétique
