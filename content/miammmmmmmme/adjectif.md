...
image: https://commons.wikimedia.org/wiki/Special:FilePath/Addjectifs_djondreces_et_et_sudjetreces_tåvlea.jpg
---
...
> [!Infobox]
> **Adjectif**
> ![[https://commons.wikimedia.org/wiki/Special:FilePath/Addjectifs_djondreces_et_et_sudjetreces_tåvlea.jpg|300]]
> - **Représente** : propriété
> - **Entrée dans un tableau d'abréviation** : صف, ਵਿ., sıf., ص, agg.
> - **Élément lexème exemplaire** : Following, le suiveur, Alès Adamovitch, Aníbal Zañartu
> - **Nom court** : ADJ
...
L'adjectif est un groupe de nom qui précise ou qui caractérise d'autres groupes de mots tel que le nom et le pronom. En français l'adjectif s'accorde en genre et en nombre avec le nom auquel il est associé.
Ex.: Le chat est gentil / La chatte est gentille

## Adjectif de couleur

Lorsqu'un adjectif est placé pour décrire la couleur d'un animal, d'un object ou de toute autre chose, il y a des accords particuliers. Quand l'adjectif est derivé d'un nom, il reste invariable. Alors que s'il est derivé d'une couleur, il s'accorde avec le nom auquel il est associé.
Ex.: Des pantalons marron (derivé du nom marron) / des chaussures bleues (pas dérivé d'un nom)
...
En anglais, l'adjectif peut occuper trois positions; il peut être épithète, attribut (du sujet ou de l'objet) ou appositif. Les adjectifs épithètes se placent le plus souvent avant le substantif qu'ils qualifient. Lorsque plusieurs adjectifs qualifient un même substantif, ils suivent un ordre précis: opinion, taille, âge, forme, origine, couleur, matière. Ainsi, on écrit par exemple: a nice (opinion) little (taille) old (âge) round (forme) white (couleur) brick (matière) house.
